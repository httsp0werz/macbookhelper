Ниже приведён обновлённый вариант раздела **README.md**, в который добавлена рекомендация по включению аутентификации по отпечатку пальца (Touch ID) для sudo:
